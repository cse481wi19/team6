...
def main():
    ...
    pose_obj = Pose()
    pose_obj.position.x = 0.6
    pose_obj.position.y = -0.1
    pose_obj.position.z = 0.7
    pose_obj.orientation.x = 0
    pose_obj.orientation.y = 0
    pose_obj.orientation.z = 0.38268343
    pose_obj.orientation.w = 0.92387953

    m = tft.quaternion_matrix([0, 0, 0.38268343, 0.92387953])
    m[0, 3] = pose_obj.position.x
    m[1, 3] = pose_obj.position.y
    m[2, 3] = pose_obj.position.z

    m2 = tft.quaternion_matrix([0, 0, 0, 1])
    m2[0, 3] = -0.1

    print(transform_to_pose(np.dot(m, m2)))
